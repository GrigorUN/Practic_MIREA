...
-- Equation(s):
-- \y~0_combout\ = (\a1~input_o\ & (\b0~input_o\ & (!\a0~input_o\ & \b1~input_o\))) # (!\a1~input_o\ & ((\b1~input_o\) # ((\b0~input_o\ & !\a0~input_o\))))
...
-- Equation(s):
-- \y~1_combout\ = (\a2~input_o\ & (\b2~input_o\ & \y~0_combout\)) # (!\a2~input_o\ & ((\b2~input_o\) # (\y~0_combout\)))
